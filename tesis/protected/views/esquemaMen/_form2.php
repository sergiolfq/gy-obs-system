...
<div class="row">
	...
	<div class="span-5">
		...
		<?php echo $form->textField($a_1,'[1]mes_esq',array('size'=>20,'maxlength'=>20,'readonly'=>true)); ?>
		<?php echo $form->error($a_1,'[1]mes_esq'); ?>
	</div>

	<div class="span-2">
		<?php echo $form->labelEx($a_1,'[1]div1'); ?>
		<?php echo $form->dropDownList($a_1,'[1]div1',$a_1->opciones(),array('disabled'=>'disabled')); ?>
		<?php echo $form->error($a_1,'[1]div1'); ?>
	</div>

	<div class="span-2">
		<?php echo $form->labelEx($a_1,'[1]div2'); ?>
		<?php echo $form->dropDownList($a_1,'[1]div2',$a_1->opciones(),array('disabled'=>'disabled')); ?>
		<?php echo $form->error($a_1,'[1]div2'); ?>
	</div>

	<div class="span-2">
		<?php echo $form->labelEx($a_1,'[1]div3'); ?>
		<?php echo $form->dropDownList($a_1,'[1]div3',$a_1->opciones(),array('disabled'=>'disabled')); ?>
		<?php echo $form->error($a_1,'[1]div3'); ?>
	</div>

	<div class="span-2">
		<?php echo $form->labelEx($a_1,'[1]div4'); ?>
		<?php echo $form->dropDownList($a_1,'[1]div4',$a_1->opciones(),array('disabled'=>'disabled')); ?>
		<?php echo $form->error($a_1,'[1]div4'); ?>
	</div>

	<div class="span-2">
		<?php echo $form->labelEx($a_1,'[1]div5'); ?>
		<?php echo $form->dropDownList($a_1,'[1]div5',$a_1->opciones(),array('disabled'=>'disabled')); ?>
		<?php echo $form->error($a_1,'[1]div5'); ?>
	</div>

	<div class="span-2">
		<?php echo $form->labelEx($a_1,'[1]div6'); ?>
		<?php echo $form->dropDownList($a_1,'[1]div6',$a_1->opciones(),array('disabled'=>'disabled')); ?>
		<?php echo $form->error($a_1,'[1]div6'); ?>
	</div>
	...
	<div class="span-10">
		...
		<?php echo $form->textArea($a_1,'[1]obs_esq',array('rows'=>1, 'cols'=>50,'readonly'=>true)); ?>
...
<div class="row">
	...
	<div class="span-5">
		...
		<?php echo $form->textField($a_2,'[2]mes_esq',array('size'=>20,'maxlength'=>20,'readonly'=>true)); ?>
		<?php echo $form->error($a_2,'[]mes_esq'); ?>
	</div>

        <div class="span-2">
		<?php echo $form->labelEx($a_2,'[2]div1'); ?>
		<?php echo $form->dropDownList($a_2,'[2]div1',$a_2->opciones(),array('disabled'=>'disabled')); ?>
		<?php echo $form->error($a_2,'[2]div1'); ?>
	</div>

	<div class="span-2">
		<?php echo $form->labelEx($a_2,'[2]div2'); ?>
		<?php echo $form->dropDownList($a_2,'[2]div2',$a_2->opciones(),array('disabled'=>'disabled')); ?>
		<?php echo $form->error($a_2,'[2]div2'); ?>
	</div>

	<div class="span-2">
		<?php echo $form->labelEx($a_2,'[2]div3'); ?>
		<?php echo $form->dropDownList($a_2,'[2]div3',$a_2->opciones(),array('disabled'=>'disabled')); ?>
		<?php echo $form->error($a_2,'[2]div3'); ?>
	</div>

	<div class="span-2">
		<?php echo $form->labelEx($a_2,'[2]div4'); ?>
		<?php echo $form->dropDownList($a_2,'[2]div4',$a_2->opciones(),array('disabled'=>'disabled')); ?>
		<?php echo $form->error($a_2,'[2]div4'); ?>
	</div>

	<div class="span-2">
		<?php echo $form->labelEx($a_2,'[2]div5'); ?>
		<?php echo $form->dropDownList($a_2,'[2]div5',$a_2->opciones(),array('disabled'=>'disabled')); ?>
		<?php echo $form->error($a_2,'[2]div5'); ?>
	</div>

	<div class="span-2">
		<?php echo $form->labelEx($a_2,'[2]div6'); ?>
		<?php echo $form->dropDownList($a_2,'[2]div6',$a_2->opciones(),array('disabled'=>'disabled')); ?>
		<?php echo $form->error($a_2,'[2]div6'); ?>
	</div>
	...
	<div class="span-10">
		...
		<?php echo $form->textArea($a_2,'[2]obs_esq',array('rows'=>1, 'cols'=>50,'readonly'=>true)); ?>
...
<div class="row">
	...
	<div class="span-5">
		...
		<?php echo $form->textField($a_3,'[3]mes_esq',array('size'=>20,'maxlength'=>20,'readonly'=>true)); ?>
		<?php echo $form->error($a_3,'[3]mes_esq'); ?>
	</div>

	<div class="span-2">
		<?php echo $form->labelEx($a_3,'[3]div1'); ?>
		<?php echo $form->dropDownList($a_3,'[3]div1',$a_3->opciones(),array('disabled'=>'disabled')); ?>
		<?php echo $form->error($a_3,'[3]div1'); ?>
	</div>

	<div class="span-2">
		<?php echo $form->labelEx($a_3,'[3]div2'); ?>
		<?php echo $form->dropDownList($a_3,'[3]div2',$a_3->opciones(),array('disabled'=>'disabled')); ?>
		<?php echo $form->error($a_3,'[3]div2'); ?>
	</div>

	<div class="span-2">
		<?php echo $form->labelEx($a_3,'[3]div3'); ?>
		<?php echo $form->dropDownList($a_3,'[3]div3',$a_3->opciones(),array('disabled'=>'disabled')); ?>
		<?php echo $form->error($a_3,'[3]div3'); ?>
	</div>

	<div class="span-2">
		<?php echo $form->labelEx($a_3,'[3]div4'); ?>
		<?php echo $form->dropDownList($a_3,'[3]div4',$a_3->opciones(),array('disabled'=>'disabled')); ?>
		<?php echo $form->error($a_3,'[3]div4'); ?>
	</div>

	<div class="span-2">
		<?php echo $form->labelEx($a_3,'[3]div5'); ?>
		<?php echo $form->dropDownList($a_3,'[3]div5',$a_3->opciones(),array('disabled'=>'disabled')); ?>
		<?php echo $form->error($a_3,'[3]div5'); ?>
	</div>

	<div class="span-2">
		<?php echo $form->labelEx($a_3,'[3]div6'); ?>
		<?php echo $form->dropDownList($a_3,'[3]div6',$a_3->opciones(),array('disabled'=>'disabled')); ?>
		<?php echo $form->error($a_3,'[3]div6'); ?>
	</div>
...
<div class="span-20">
	...
	<div class="span-10">
		...
		<?php echo $form->textArea($a_3,'[3]obs_esq',array('rows'=>1, 'cols'=>50,'readonly'=>true)); ?>
...
<div class="row">
	...
	<div class="span-5">
		...
		<?php echo $form->textField($a_4,'[4]mes_esq',array('size'=>20,'maxlength'=>20,'readonly'=>true)); ?>
		<?php echo $form->error($a_4,'[4]mes_esq'); ?>
	</div>

	<div class="span-2">
		<?php echo $form->labelEx($a_4,'[4]div1'); ?>
		<?php echo $form->dropDownList($a_4,'[4]div1',$a_4->opciones(),array('disabled'=>'disabled')); ?>
		<?php echo $form->error($a_4,'[4]div1'); ?>
	</div>

	<div class="span-2">
		<?php echo $form->labelEx($a_4,'[4]div2'); ?>
		<?php echo $form->dropDownList($a_4,'[4]div2',$a_4->opciones(),array('disabled'=>'disabled')); ?>
		<?php echo $form->error($a_4,'[4]div2'); ?>
	</div>

	<div class="span-2">
		<?php echo $form->labelEx($a_4,'[4]div3'); ?>
		<?php echo $form->dropDownList($a_4,'[4]div3',$a_4->opciones(),array('disabled'=>'disabled')); ?>
		<?php echo $form->error($a_4,'[4]div3'); ?>
	</div>

	<div class="span-2">
		<?php echo $form->labelEx($a_4,'[4]div4'); ?>
		<?php echo $form->dropDownList($a_4,'[4]div4',$a_4->opciones(),array('disabled'=>'disabled')); ?>
		<?php echo $form->error($a_4,'[4]div4'); ?>
	</div>

	<div class="span-2">
		<?php echo $form->labelEx($a_4,'[4]div5'); ?>
		<?php echo $form->dropDownList($a_4,'[4]div5',$a_4->opciones(),array('disabled'=>'disabled')); ?>
		<?php echo $form->error($a_4,'[4]div5'); ?>
	</div>

	<div class="span-2">
		<?php echo $form->labelEx($a_4,'[4]div6'); ?>
		<?php echo $form->dropDownList($a_4,'[4]div6',$a_4->opciones(),array('disabled'=>'disabled')); ?>
		<?php echo $form->error($a_4,'[4]div6'); ?>
	</div>
...
<div class="span-20">
	...
	<div class="span-10">
		...
		<?php echo $form->textArea($a_4,'[4]obs_esq',array('rows'=>1, 'cols'=>50,'readonly'=>true)); ?>
