...
<div class="span-4">
	...
	<div class="span-2">
		...
		<?php echo $form->textField($model,'peso_anterior',array('size'=>6,'maxlength'=>45)); ?>
		<?php echo $form->error($model,'peso_anterior'); ?>
	</div>

	<div class="span-2">
		<?php echo $form->labelEx($model,'talla'); ?>
		<?php echo $form->textField($model,'talla',array('size'=>3,'maxlength'=>45)); ?>
	...
	<div class="span-2">
		...
		<?php echo $form->dropDownList($model,'vdrl',$model->opcionesPositivo()); ?>
...
<div class="row">
	<div class="span-3">
		...
		<?php echo $form->dropDownList($model,'tipo_parto',$model->opcionesParto()); ?>
		<?php echo $form->error($model,'tipo_parto'); ?>
	</div>

	<div class="span-2">
		<?php echo $form->labelEx($model,'hora'); ?>
		<?php echo $form->textField($model,'hora',array('size'=>4,'maxlength'=>45)); ?>
	...
	<div class="span-2">
		...
		<?php echo $form->dropDownList($model,'muerte_fetal',$model->opciones()); ?>
		<?php echo $form->error($model,'muerte_fetal'); ?>
	</div>

	<div class="span-1">
		<?php echo $form->labelEx($model,'sexo'); ?>
		<?php echo $form->dropDownList($model,'sexo',$model->opcionesSexo()); ?>
		<?php echo $form->error($model,'sexo'); ?>
	</div>

	<div class="span-2">
		<?php echo $form->labelEx($model,'peso'); ?>
		<?php echo $form->textField($model,'peso',array('size'=>4,'maxlength'=>45)); ?>
		<?php echo $form->error($model,'peso'); ?>
	</div>

	<div class="span-2">
		<?php echo $form->labelEx($model,'vdrl_em'); ?>
		<?php echo $form->dropDownList($model,'vdrl_em',$model->opcionesPositivo()); ?>
	...
	<div class="row">
		...
		<?php echo $form->textField($model,'talla_final',array('size'=>3,'maxlength'=>45)); ?>
		<?php echo $form->error($model,'talla_final'); ?>
	</div>
<br/>
	<div class="span-2">
		<?php  if ($model->estado==1){ echo CHtml::label('¿Desea desactivar embarazo? ','anuncio');}//'<label> Desea desactivar embarazo?  </label>'; } ?>
		<?php  if ($model->estado==1){ echo CHtml::checkBox('desactivar'); }?>
	...
	<div class="row span-20 buttons">
		<?php echo CHtml::submitButton($model->isNewRecord ? 'Crear' : 'Guardar',array('class'=>'positive')); ?>
	</div>
	<p class="note">Un embarazo permanece activo por dos año desde su fecha inicial a menos que lo desactive.</p>
