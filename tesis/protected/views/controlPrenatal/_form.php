...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="span-3">
		...
		<?php echo $form->textField($model,'semana',array('size'=>10,'maxlength'=>45)); ?>
	...
	<div class="span-2">
		...
		<?php echo $form->textField($model,'p',array('size'=>5,'maxlength'=>45)); ?>
...
//,array('controlPrenatal/verEcograma/'.$model->primaryKey),array('target'=>'_blank'));}?>
	...
	<div class="span-2">
		...
		<?php echo $form->dropDownList($model,'eco',$model->opcionesNormal()); ?>
...
<div class="span-8">
		...
		<?php echo $form->textArea($model,'ecograma',array('cols'=>'50' ,'rows'=>'1') ); ?>
	...
	<div class="span-20">
		...
		<?php echo $form->textArea($model,'observaciones',array('rows'=>2,'cols'=>80)); ?>
