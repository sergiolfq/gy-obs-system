...
<div class="row">
	...
	<div class="span-3">
		...
		<?php echo $form->dropDownList($model,'involucion',$model->opcionesNormal(),array('disabled'=>'disabled')); ?>
		<?php echo $form->error($model,'involucion'); ?>
	</div>

	<div class="span-3">
		<?php echo $form->labelEx($model,'herida_qui'); ?>
		<?php echo $form->dropDownList($model,'herida_qui',$model->opciones(),array('disabled'=>'disabled')); ?>
		<?php echo $form->error($model,'herida_qui'); ?>
	</div>

	<div class="span-3">
		<?php echo $form->labelEx($model,'epiciotomia'); ?>
		<?php echo $form->dropDownList($model,'epiciotomia',$model->opcionesNormal(),array('disabled'=>'disabled')); ?>
		<?php echo $form->error($model,'epiciotomia'); ?>
	</div>

	<div class="span-3">
		<?php echo $form->labelEx($model,'sangrado_gen'); ?>
		<?php echo $form->dropDownList($model,'sangrado_gen',$model->opciones(),array('disabled'=>'disabled')); ?>
		<?php echo $form->error($model,'sangrado_gen'); ?>
	</div>

	<div class="span-5">
		<?php echo $form->labelEx($model,'edema_mien_inf'); ?>
		<?php echo $form->dropDownList($model,'edema_mien_inf',$model->opciones(),array('disabled'=>'disabled')); ?>
		<?php echo $form->error($model,'edema_mien_inf'); ?>
	</div>
	<div class="span-2">
		<?php echo $form->labelEx($model,'peso'); ?>
		<?php echo $form->textField($model,'peso',array('size'=>4,'maxlength'=>25,'readonly'=>true)); ?>
		<?php echo $form->error($model,'peso'); ?>
	</div>

	<div class="span-3">
		<?php echo $form->labelEx($model,'tension'); ?>
		<?php echo $form->textField($model,'tension',array('size'=>4,'maxlength'=>25,'readonly'=>true)); ?>
		<?php echo $form->error($model,'tension'); ?>
	</div>
	<div class="span-12">
		<?php echo $form->labelEx($model,'anticoceptivo'); ?>
		<?php echo $form->textField($model,'anticoceptivo',array('size'=>25,'maxlength'=>25,'readonnly'=>true)); ?>
		<?php echo $form->error($model,'anticoceptivo'); ?>
	</div>

	<div class="span-20">
		<?php echo $form->labelEx($model,'observaciones_con'); ?>
		<?php echo $form->textArea($model,'observaciones_con',array('rows'=>3,'cols'=>80,'readonly'=>true)); ?>
